...
{
    public class YurtdisiTurView : HizmetBase
    {
        public YurtdisiTurView(int idYurtdisiTur, string adi, int fiyat, string resimUrl, DateTime baslangicTarihi, string baslangicKonumu, string guzergah, string vizeDurumu, string gunBir, string gunIki, string gunUc, string gunDort, string gunBes):base(adi,fiyat,resimUrl)
        {
